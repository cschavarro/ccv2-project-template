 ...
 */
package com.belcorp.commercewebservices.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import com.belcorp.commercewebservices.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "belcorpcommercewebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "belcorpcommercewebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "belcorpcommercewebservices.oauth2.tokenUrl";

	private static final String DESC = "belcorpcommercewebservices.v2.description";
	private static final String TITLE = "belcorpcommercewebservices.v2.title";
	private static final String VERSION = "belcorpcommercewebservices.v2.version";
	private static final String LICENSE = "belcorpcommercewebservices.v2.license";
	private static final String LICENSE_URL = "belcorpcommercewebservices.v2.license.url";
