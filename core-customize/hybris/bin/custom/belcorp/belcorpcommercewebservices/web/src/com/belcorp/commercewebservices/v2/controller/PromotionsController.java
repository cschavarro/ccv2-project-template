...
import com.belcorp.commercewebservices.product.data.PromotionDataList;
...
public class PromotionsController extends BaseController
{
	...
	static
	{
		OPTIONS = Arrays.stream(PromotionOption.values())
				.collect(Collectors.toCollection(() -> EnumSet.noneOf(PromotionOption.class)));
	}
