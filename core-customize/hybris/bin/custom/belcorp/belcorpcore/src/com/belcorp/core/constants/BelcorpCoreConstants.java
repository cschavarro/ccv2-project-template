 ...
 */
package com.belcorp.core.constants;

/**
 * Global class for all BelcorpCore constants. You can add global constants for your extension into this class.
 */
public final class BelcorpCoreConstants extends GeneratedBelcorpCoreConstants
{
	public static final String EXTENSIONNAME = "belcorpcore";


	private BelcorpCoreConstants()
	{
		//empty
	}
