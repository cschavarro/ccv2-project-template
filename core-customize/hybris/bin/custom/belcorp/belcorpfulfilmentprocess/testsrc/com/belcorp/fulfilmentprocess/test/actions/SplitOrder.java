 ...
 */
package com.belcorp.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(BelcorpFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(BelcorpFulfilmentProcessConstants.PARENT_PROCESS);
