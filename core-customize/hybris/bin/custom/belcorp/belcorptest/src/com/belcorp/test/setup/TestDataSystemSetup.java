 ...
 */
package com.belcorp.test.setup;
...
import com.belcorp.test.constants.BelcorpTestConstants;
import com.belcorp.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = BelcorpTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/belcorptest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/belcorptest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/belcorptest/import/cstickets.impex");
			...
			importImpexFile(context, "/belcorptest/import/csquotes.impex");
		}
	}
}
